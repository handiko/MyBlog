...
* Buat tabel yang berisi baris yaitu pengelompokkan region dan kolom berisi waktu UTC dari 01-24 UTC (pada contoh ini hanya ditunjukkan untuk jam 00 (24) UTC hingga 12 UTC)    
![](./TimeTable.png)

* Dari hasil prediksi VOACAP, isikan bukaan-bukaan propagasi sesuai waktu pada tabel tersebut. Ini adalah langkah yang cukup butuh ketelitian dan pertimbangan. Pada dasarnya, kita akan memasukkan data dari hasil prediksi VOACAP ke time table kita. Sebagai contoh, untuk Regional/DXCC North America, menurut prediksi VOACAP terdapat propagasi ke Zone 3 (US west coast) antara jam 00 UTC hingga 10 UTC pada band 20M, 03 UTC hingga 06 UTC pada band 15M, dan tidak ada propagasi pada 10M band. Maka, kita isikan "20" pada baris North America jam 00-10 UTC dan "15" pada jam 03-06 UTC.
![](./TimeTable-NA.png)

* Lakukan hal yang sama untuk seluruh baris Regional/DXCC.
![](./TimeTable-ALL.png)

* Dari tabel yang telah terisi tersebut, tentukan, mana yang menjadi slot untuk RUN/CQ dan mana slot waktu untuk S&P/Hunting. Sebagai contoh, saya tentukan dengan warna MERAH untuk slot RUN/CQ dan warna hitam untuk slot S&P/Hunting. Pada tiap jam hanya dialokasikan 1 band untuk RUN/CQ. Band lainnya dialokasikan untuk S&P/Hunting. Dapat diperhatikan, band yang jarang terbuka propagasinya lebih diprioritaskan dibanding band lain. Dengan demikian, peluang terlewatkannya bukaan propagasi pada band-band yang jarang tersebut dapat diminimalisir. Jikalaupun bukaan propagasi ternyata tidak terjadi, kita selalu dapat berpindah ke band lain setiap saat.
![](./TimeTable-priority.png)

* Untuk kategori SOAB, dari tabel tersebut sisihkan kembali waktu minimal 6 jam perhari untuk OFF (istirahat/tidur) agar tidak melanggar peraturan yaitu maksimum mengikuti kontes untuk SOAB adalah 36 jam dari 48 jam slot yang tersedia.
